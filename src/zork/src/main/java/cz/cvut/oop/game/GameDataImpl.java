...
public class GameDataImpl implements GameData {
    ...
    public void init(){
        ...
        Room library = new RoomImpl("knihovna", "Spousta knížek na jendom místě", new Enemy("Babka knihařka", new int[]{1,2}, 15, Enemy.enemyType.normal, new Item(new int[]{0, 1}, "Dlouhá knížka")));
        Room bedroom = new RoomImpl("loznice", "Neustlaná postel a ospalá entita", new Enemy("Ospalý syn majitele", new int[]{4,7}, 30, Enemy.enemyType.normal, new Item(new int[]{0, 1}, "Dlouhá knížka")));
        Room kitchen = new RoomImpl("kuchyn", "Neskutčný bordel v kuchyni", new Enemy("Magická létající kuchařka", new int[]{8,11}, 40, Enemy.enemyType.normal, new Item(new int[]{0, 1}, "Dlouhá knížka")));
        Room livingRoom = new RoomImpl("obyvak","Oslepující zlatý lustr ti svítí do očí", new Enemy("Securiťák", new int[]{10,12}, 50, Enemy.enemyType.normal, new Item(new int[]{0, 1}, "Dlouhá knížka")));
